...
ActiveRecord::Schema.define(version: 2021_11_09_045336) do

  create_table "password_reminders", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "token"
